    ...
    <div class="inner-wide">
      <div class="separate-block-content">
        ...
        <nav class="button-wrap">
          <a href="<?php echo esc_url( home_url() ); ?>/product/category/environmental-conservation-concrete-block/" class="button button__base">環境保全コンクリートブロック</a>
        </nav>
      </div>
  ...
  <section class="sec sec--separate-block sec--separate-block--environment">
    <div class="inner-wide">
      <div class="separate-block-content">
        ...
        <nav class="button-wrap">
          <a href="<?php echo esc_url( home_url() ); ?>/product/category/landscape-function-concrete-block/" class="button button__base">景観機能コンクリートブロック</a>
        </nav>
      </div>
      <div class="separate-block-image"></div>
    </div>
  ...
  <section class="sec sec--separate-block sec--separate-block--structure">
    <div class="inner-wide">
      <div class="separate-block-content">
        ...
        <nav class="button-wrap">
          <a href="<?php echo esc_url( home_url() ); ?>/product/category/structural-unction-concrete-block/" class="button button__base">構造機能コンクリートブロック</a>
        </nav>
      </div>
      <div class="separate-block-image"></div>
    </div>
