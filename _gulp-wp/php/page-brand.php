...
?>
  ...
  <section class="sec sec--brand-sdgs">
    <div class="inner-medium">
      <div class="sdgs-text">
        <h2>SDGsへ貢献する製品へ</h2>
        <p>山富産業株式会社は、時流に先んじた事業展開を図り永続的に社会に貢献すること。ならびに地球的な視野に立った豊かな環境の創造提案企業であることを経営理念の柱とし、人と自然、人と経済、人と他の生物の関係を重視した環境保全型の製品をつくり出してきました。SDGs達成の目的とも重なるこの活動を大切にし、人と社会にたくさんのしあわせな環境をつくり、SDGs達成に貢献していきます。</p>
      </div>
