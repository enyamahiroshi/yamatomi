...
?>
  ...
  <section class="sec sec--brand-sdgs">
    <div class="inner-medium">
      <div class="sdgs-text">
        <h2>SDGsへ貢献する製品へ</h2>
        <p>山富産業株式会社は、時流に先んじた事業展開を図り永続的に社会に貢献すること。ならびに地球的な視野に立った豊かな環境の創造提案企業であることを経営理念の柱とし、人と自然、人と経済、人と他の生物の関係を重視した環境保全製品や景観製品をつくり出してきました。SDGs達成の目的とも重なるこの活動を大切にし、人と社会にたくさんのしあわせな環境をつくり、SDGs達成に貢献していきます。</p>
      </div>
    ...
    <div class="inner-wide">
      <div class="separate-block-content">
        <div class="separate-block-content__head">
          ...
          <strong class="separate-block-content__head__catchcopy">省力化、安全性、施工性を実現するブロック。</strong>
        </div>
        <p class="separate-block-content__text">
        確かな基本構造により、安全性と耐久性、そして施工効率を追求しコストダウンを図ります。経済環境と施工環境に対して今何ができるかを考え、開発力と技術力で提案します。<br>山富産業の考える構造機能は、省力化、安全性と施工性と耐久性です。コンクリートブロックは強度と確かな施工が求められ、それは施工後数十年という年月に渡り維持されるものです。山富産業は、コストパフォーマンスは性能であり一つの機能であると考え、施工性、作業性の良さ、生産性の向上にアイデアを注ぎます。
        </p>
       <?php /* <nav class="button-wrap">
