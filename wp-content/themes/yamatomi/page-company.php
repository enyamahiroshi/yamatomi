  ...
  <section class="sec sec--separate-kv sec--separate-kv--company">
    <div class="inner-wide">
      <div class="separate-kv__content">
        ...
        <p class="separate-kv__content__text">その中で、私たちが常に大切に想い、描いてきたことは、豊かな環境を未来につなげていくこと。社会環境、自然環境、経済環境など私たち人間を取り巻くあらゆる環境に対して、常に今以上を考え、実現していくことが私たちの使命だと考えています。</p>
        <p class="separate-kv__content__text">現在、世界規模で災害対策、インフラ環境の整備という中で、人が作り出したものと自然との共生ということが大きなテーマとして、様々なかたちで取り組まれています。私たちもまた、環境保全型という独自技術で開発したコンクリートブロック製品を以て、地球的な視野に立った豊かな環境づくりに貢献してまいります。</p>
